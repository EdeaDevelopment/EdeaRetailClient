    ...
    <div class="nav-left">
      <a class="nav-item">
        <router-link to="/ShoppingCart">
          <div>
            <a class="cd-img-replace shoppingcarticon" href="#0" v-on:click="cartTrigger">
              <icon name="shopping-cart" scale="3"></icon>
            </a>
          </div>
        </router-link>
      </a>
...
export default {
  ...
  computed: {
    ...
    itemsCount() {
      var itemCount = this.$store.getters['ShoppingCartModule/ItemsCount']
      return itemCount
    }
  },
  methods: {
