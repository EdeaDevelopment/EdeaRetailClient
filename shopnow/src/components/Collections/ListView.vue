            ...
            <ul v-if="layout === 'list'" class="list">
                <li v-for="(item, index) in transactionItems">
                    <div class="columns">
                      ...
                      <section>
                        <div class="container">
                          <h1 class="title">{{item.ItemDescription}}</h1>
                          <h2 class="subtitle">
                            <p>כמות :{{item.ItemQuantity}} , הנחה: {{item.DiscountPercent}}, סה"כ נטו לשורה: {{item.TotalPrice}}</p>
                            <p> מבצע ראשון למוצר :{{item.FirstSaleDescription}}</p>
                          </h2>
                        </div>
                      </section>
                      </div>
